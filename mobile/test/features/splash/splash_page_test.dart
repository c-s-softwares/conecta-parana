...
void main() {
  testWidgets(
    'Deve navegar para /home quando autenticado e com cidade completa',
  ...
  testWidgets(
    'Deve navegar para /onboarding quando autenticado porem sem cidade configurada',
    (WidgetTester tester) async {
      String? rotaAlvo;
  ...
  testWidgets('Deve navegar para /login quando nao autenticado no sistema', (
    WidgetTester tester,
  ) async {
    String? rotaAlvo;
